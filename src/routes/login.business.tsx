  ...
  component: () => (
    <div className="min-h-screen flex items-center justify-center bg-black p-6">
      <div className="bg-card rounded-3xl p-8 max-w-md w-full text-center shadow-2xl">
        <div className="h-20 w-20 mx-auto rounded-full bg-black flex items-center justify-center overflow-hidden ring-1 ring-primary/30 shrink-0">
          <img src={logoIcon} alt="MT 24horas express" className="h-full w-full object-cover rounded-full"/>
        </div>
        <h1 className="mt-4 text-2xl font-black">MT 24horas express</h1>
