...
public class NativeSoundPlayer {
    ...
    public static void playOrderAlert(Context context) {
        synchronized (lock) {
            try {
                stopSound();
                ...
                mediaPlayer.start();
                Log.d(TAG, "Áudio oficial MT 24 Horas Lojista iniciado com sucesso!");
                ...
                Log.e(TAG, "Erro ao tocar áudio: " + e.getMessage(), e);
            }
        }
    }
        ...
        synchronized (lock) {
            try {
                ...
                if (mediaPlayer != null) {
                    ...
                    mediaPlayer.release();
                    mediaPlayer = null;
                    Log.d(TAG, "Áudio oficial MT 24 Horas Lojista parado.");
                }
            } catch (Exception e) {
